...
public class    IssueEntity extends BaseEntity {
    ...
    // ===== DAMAGE/OFF_ROUTE compensation =====
    // NOTE: Compensation data is now stored in IssueCompensationAssessmentEntity (unified for DAMAGE and OFF_ROUTE)
    // Use CompensationService to manage compensation assessments
    @OneToOne(mappedBy = "issue", fetch = FetchType.LAZY)
    private IssueCompensationAssessmentEntity compensationAssessment;
